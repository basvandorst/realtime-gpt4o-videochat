...
const STEDEN = {
  breda: {
    ...
    spots: [
      { naam: "Ronde Bonen", tagline: "twaalf stoelen, één branderij, nul compromissen", cat: "Koffie", buurt: "Ginnekenweg", meta: "€ · vanaf 08:00", datum: "2026-07-10", foto: FOTO.koffie,
      ...
      { naam: "Bar Barrière", tagline: "vijftig natuurwijnen achter een groene deur", cat: "Wijn", buurt: "Haagdijk", meta: "€€ · vanaf 17:00", datum: "2026-07-03", foto: FOTO.wijn,
        adres: "Haagdijk 8a",
      ...
      { naam: "Noedelbar Noord", tagline: "handgetrokken noedels in een oude loods", cat: "Eten", buurt: "Belcrum", meta: "€€ · alleen diner", datum: "2026-06-26", foto: FOTO.ramen,
      ...
      { naam: "Boterham & Zo", tagline: "de croissant die om 11:30 uitverkocht is", cat: "Bakkerij", buurt: "Centrum", meta: "€ · 08:00–16:00", datum: "2026-06-18", foto: FOTO.croissant,
      ...
      { naam: "Studio Stof", tagline: "Dutch design, droogbloemen en keramiek", cat: "Winkels", buurt: "Ginneken", meta: "di t/m za", datum: "2026-05-29", foto: FOTO.winkel,
      ...
      { naam: "Café Vroeg", tagline: "licht, ruim en de hele dag ontbijt", cat: "Koffie", buurt: "Centrum", meta: "€ · 08:00–17:00", datum: "2026-05-15", foto: FOTO.cafe,
      ...
      { naam: "Dakterras DK9", tagline: "aperitivo met de Grote Kerk op ooghoogte", cat: "Drinken", buurt: "Centrum", meta: "€€€ · reserveren aangeraden", datum: "2026-07-18", foto: FOTO.cocktails,
      ...
      { naam: "Loods Lumen", tagline: "lichtkunst en open studio's aan het water", cat: "Cultuur", buurt: "Havenkwartier", meta: "gratis · do t/m zo", datum: "2026-07-25", foto: FOTO.galerie,
        adres: "Havenkade 12",
      ...
      { naam: "De Leeszaal", tagline: "boekhandel, leescafé en klein podium ineen", cat: "Cultuur", buurt: "Belcrum", meta: "gratis · dagelijks", datum: "2026-08-02", foto: FOTO.boeken,
      ...
      { naam: "Lange Tafels", tagline: "één avond, één straat, samen eten in Belcrum", cat: "Eten", buurt: "Belcrum", meta: "€€ · eenmalig zomerdiner", datum: "2026-08-15", foto: FOTO.tafel,
  ...
  amsterdam: {
    ...
    spots: [
      { naam: "Bak & Boon", tagline: "specialty coffee tussen de marktkramen", cat: "Koffie", buurt: "De Pijp", meta: "€ · vanaf 08:00", datum: "2026-07-08", foto: FOTO.koffie, adres: "Albert Cuypstraat 87" },
      { naam: "Wijnlokaal West", tagline: "natuurwijn en kaarslicht in de Jordaan", cat: "Wijn", buurt: "Jordaan", meta: "€€ · vanaf 16:00", datum: "2026-07-01", foto: FOTO.wijn, adres: "Westerstraat 112" },
      { naam: "Broedplaats Noord", tagline: "ramen en vinyl in een oude scheepsloods", cat: "Eten", buurt: "Noord", meta: "€€ · alleen diner", datum: "2026-06-20", foto: FOTO.ramen, adres: "NDSM-plein 6" },
      { naam: "Zuurdesem & Zonen", tagline: "de bakkerij waar Oost voor omfietst", cat: "Bakkerij", buurt: "Oost", meta: "€ · 08:00–16:00", datum: "2026-06-10", foto: FOTO.croissant, adres: "Javastraat 41" },
      { naam: "Kade Twaalf", tagline: "rooftop-aperitivo met uitzicht over het IJ", cat: "Drinken", buurt: "Noord", meta: "€€€ · reserveren aangeraden", datum: "2026-07-21", foto: FOTO.cocktails, adres: "IJkade 12" },
      { naam: "Galerie Gracht", tagline: "jonge makers in een oud grachtenpand", cat: "Cultuur", buurt: "Centrum", meta: "gratis · wo t/m zo", datum: "2026-08-05", foto: FOTO.galerie, adres: "Keizersgracht 209" },
    ],
  },
  antwerpen: {
    ...
    spots: [
      { naam: "Koffie Kompas", tagline: "slow bar met branderij op het Zuid", cat: "Koffie", buurt: "Zuid", meta: "€ · vanaf 08:00", datum: "2026-07-05", foto: FOTO.koffie, adres: "Vlaamsekaai 18" },
      { naam: "Vin Vin", tagline: "natuurwijn onder de art-nouveaugevels", cat: "Wijn", buurt: "Zurenborg", meta: "€€ · vanaf 17:00", datum: "2026-06-24", foto: FOTO.wijn, adres: "Cogels-Osylei 55" },
      { naam: "Atelier Acht", tagline: "Belgisch design en keramiek aan de kade", cat: "Winkels", buurt: "Eilandje", meta: "di t/m za", datum: "2026-06-12", foto: FOTO.winkel, adres: "Napoleonkaai 8" },
      { naam: "Tafel van Tien", tagline: "één lange tafel, één menu, elke avond vol", cat: "Eten", buurt: "Borgerhout", meta: "€€ · alleen diner", datum: "2026-05-20", foto: FOTO.tafel, adres: "Turnhoutsebaan 90" },
      { naam: "MAS Boven", tagline: "aperitivo met de haven aan je voeten", cat: "Drinken", buurt: "Eilandje", meta: "€€€ · reserveren aangeraden", datum: "2026-07-30", foto: FOTO.cocktails, adres: "Hanzestedenplaats 1" },
      { naam: "Lichthal", tagline: "lichtkunst in een voormalig pakhuis", cat: "Cultuur", buurt: "Eilandje", meta: "gratis · do t/m zo", datum: "2026-08-09", foto: FOTO.galerie, adres: "Sint-Aldegondiskaai 30" },
    ],
  },
  berlijn: {
    ...
    spots: [
      { naam: "Kaffee Kollektiv", tagline: "branderij en bakkerij aan het kanaal", cat: "Koffie", buurt: "Kreuzberg", meta: "€ · vanaf 08:00", datum: "2026-07-06", foto: FOTO.koffie, adres: "Paul-Lincke-Ufer 22" },
      { naam: "Ramen Rixdorf", tagline: "handgetrokken noedels in een hinterhof", cat: "Eten", buurt: "Neukölln", meta: "€€ · alleen diner", datum: "2026-06-28", foto: FOTO.ramen, adres: "Richardstraße 34" },
      { naam: "Buchbar", tagline: "boekhandel met wijnbar tot middernacht", cat: "Cultuur", buurt: "Prenzlauer Berg", meta: "gratis · dagelijks", datum: "2026-06-05", foto: FOTO.boeken, adres: "Kastanienallee 77" },
      { naam: "Dach Drei", tagline: "rooftop boven de daken van Mitte", cat: "Drinken", buurt: "Mitte", meta: "€€€ · reserveren aangeraden", datum: "2026-07-22", foto: FOTO.cocktails, adres: "Torstraße 3" },
      { naam: "Galerie Grau", tagline: "jonge kunst in een betonnen hal", cat: "Cultuur", buurt: "Mitte", meta: "gratis · wo t/m zo", datum: "2026-08-12", foto: FOTO.galerie, adres: "Linienstraße 158" },
    ],
  },
};
